...
const Pacientes = ({paciente, setPaciente, eliminarPaciente}) => {
  const {nombre, propietario, email, fingreso, sintomas, id} = paciente
 ...
 /* const handleEliminar = () =>{
  ...
  return (
    <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
          ...
          <p className="font-bold mb-3 text-gray-700 uppercase">Fecha de Ingreso:{' '}<span className="font-normal normal-case">{fingreso}</span></p>
          ...
          <div className="flex justify-between mt-10">
            ...
            <button type="button" className="py-2 px-10 bg-red-600
             hover:bg-red-700 font-bold uppercase text-white rounded-lg"
